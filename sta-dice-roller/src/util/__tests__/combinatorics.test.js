...
describe("Test STA pool calculator", () => {
  ...
  describe("Test against static data generated by enumeration", () => {
    ...
    describe("Test against complications data", ()=>{
      const complicationsTestArgs = FlattenComplicationsJSONObj(complicationsJSONObj);
      test.each(complicationsTestArgs)("%i, %i, %o",(numDice, complicationsRange, ref)=>{
        const res = complicationsFrequencyTable({numDice, complicationsRange});
      });
    });
  });
});
